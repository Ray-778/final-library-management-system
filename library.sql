...
VALUES
	...
	( 2, 'Java EE框架整合开发入门到实践', '陈恒', '清华大学出版社', '9787302502968', '详细讲解了Java EE中Spring、Spring MVC和MyBatis三大框架（SSM）的基础知识和实际应用。为了更好地帮助读者学习SSM框架，本书以大量案例介绍了SSM框架的基本思想、方法和技术。', '中文', '69.80', '2018-09', 13, 1 ),
	( 3, '马克思主义基本原理概论', '思想政治小组', '高等教育出版社', '9787040494792', '从总体上理解和把握什么是马克思主义，了解马克思主义产生的历史过程和发展阶段，掌握马克思主义的鲜明特征，深刻认识马克思主义的当代价值，增强学习和运用马克思主义的自觉性。', '中文', '23.00', '2018-04', 1, 1 ),
	( 4, '计算机网络', '谢希人', '电子工业出版社', '9787121302954', '本书的特点是概念准确、论述严谨、内容新颖、图文并茂、突出进本原理和基本概念的阐述，同时力图反应计算机网络的一些最新发展。本书可供电气信息类和计算机类专业大学本科生和研究生使用。', '中文', '49.00', '2017-07', 7, 13 ),
