...
VALUES
	( 1, '计算机制全息图', '金国藩 ', '科学出版社', '9787030647146', '本书系统介绍了计算全息的基础理论和关键技术, 主要内容可以分为三大部分, 先介绍了计算全息的基础理论, 包括全息术与计算全息的发展、采样理论、光波的数学描述以及标量衍射的计算等内容 ; 其次介绍了计算全息的编码方法, 着重讨论了将空间复数信号变换为计算全息图的波前调制函数的相关技术 ; 最后, 重点介绍了计算全息的三个典型应用领域: 干涉检测、三维显示及波前调控, 并对相关技术进行了详细的讨论。', '中文', '35.00', '2017-06-01', 9, 10 ),
	( 2, 'Java EE框架整合开发入门到实践', '陈恒', '清华大学出版社', '9787302502968', '详细讲解了Java EE中Spring、Spring MVC和MyBatis三大框架（SSM）的基础知识和实际应用。为了更好地帮助读者学习SSM框架，本书以大量案例介绍了SSM框架的基本思想、方法和技术。', '中文', '69.80', '2018-09-01', 13, 1 ),
	( 3, 'C++语言导学', '本贾尼·斯特劳斯特鲁普', '机械工业出版社', '9787111633280', '在本书中，作者通过介绍编程风格（例如面向对象编程和泛型编程）引出支持它们的C++特性。从基本特性开始，延伸到更宽范围的进阶主题，包括很多C++17新特性，例如移动语义、一致初始化、lambda表达式、改进的容器、随机数以及并发。本书非常全面，甚至包含一些为C++20提出的扩展，例如概念和模块。本书最后讨论了C++语言的设计和演化。', '中文', '23.00', '2018-04-01', 1, 1 ),
	( 4, '计算机网络', '谢希仁', '电子工业出版社', '9787121302954', '本书的特点是概念准确、论述严谨、内容新颖、图文并茂、突出进本原理和基本概念的阐述，同时力图反应计算机网络的一些最新发展。本书可供电气信息类和计算机类专业大学本科生和研究生使用。', '中文', '49.00', '2017-07-03', 7, 13 ),
	...
	( 15, 'Java软件开发技术', '赖敏 ', '清华大学出版社 ', '9787302518990', '本书核心内容包括Java语言基础，Java数组与字符串，Java类与对象的所有知识点，继承的相关知识点，Java图形用户界面设计，Java异常处理机制，Java常用的类，Java输入输出及文件操作，Java集合框架，Java多线程，Java网络编程。', '中文', '42.00', '2015-06-01', 1, 1 ),
	( 16, 'C/C++程序设计教程', '郑秋生', '电子工业出版社  ', '9787121330476', '	本书阐述了C++语言中面向对象程序设计的语言和思想，内容包括：类和对象、继承与派生、多态性、输入/输出流、异常处理、模板、标准模板库STL的介绍及应用等。', '中文', '42.00', '2015-06-01', 1, 1 );
