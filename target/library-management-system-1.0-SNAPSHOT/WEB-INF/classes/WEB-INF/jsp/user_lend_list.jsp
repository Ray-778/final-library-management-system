...
<div style="padding: 70px 550px 10px">
    <form   method="post" action="user_lendquery.html" class="form-inline"  id="searchform">
            ...
            <table class="table table-hover">
                ...
                <c:forEach items="${list}" var="alog">
                    <tr>
                        ...
                        <c:choose>
                            <c:when test="${alog.djs<=3&&alog.djs>0}">
                        ...
                        <td>
                            <a href="backbook.html?serNum=<c:out value='${alog.ser_num}'></c:out>">
                                <c:if test="${alog.djs<=3&&alog.backDate==null}">
                                    <button type="button" class="btn btn-danger btn-xs">催促归还</button>
                                </c:if>
                                <c:if test="${alog.djs>3&&alog.backDate==null}">
                                    <button type="button" class="btn btn-default btn-xs" disabled="disabled">催促归还</button>
                                </c:if>
                            </a>
                        </td>
                    </tr>
